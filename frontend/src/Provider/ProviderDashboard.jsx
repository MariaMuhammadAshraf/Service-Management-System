...
//     try {
//       const res = await axios.put(`http://localhost:5000/api/auth/toggle-availability/${userId}`);
...
//   try {
//     await axios.put(`http://localhost:5000/api/bookings/${id}/provider-status`, {
//       status,
//       providerId: userId
//     });
...
const ProviderDashboard = () => {
  ...
  const updateStatus = async (id, status) => {
    try {
      await axios.put(`http://localhost:5000/api/bookings/${id}/provider-status`, { status, providerId: userId });
      fetchDashboard();
