...
//     try {
//       const res = await axios.put(`https://service-management-system-ywma.vercel.app/api/auth/toggle-availability/${userId}`);
...
//   try {
//     await axios.put(`https://service-management-system-ywma.vercel.app/api/bookings/${id}/provider-status`, {
//       status,
//       providerId: userId
//     });
//     // Re-fetch dashboard data to update the UI
//     const res = await axios.get(`https://service-management-system-ywma.vercel.app/api/dashboard/${userId}`);
...
const ProviderDashboard = () => {
  ...
  const updateStatus = async (id, status) => {
    try {
      await axios.put(`https://service-management-system-ywma.vercel.app/api/bookings/${id}/provider-status`, { status, providerId: userId });
      fetchDashboard();
