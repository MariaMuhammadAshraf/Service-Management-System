...
//     try {
//       const res = await axios.put(`http://https://service-management-system-oc50.vercel.app/api/api/api/auth/toggle-availability/${userId}`);
...
//   try {
//     await axios.put(`http://https://service-management-system-oc50.vercel.app/api/api/api/bookings/${id}/provider-status`, {
//       status,
//       providerId: userId
//     });
//     // Re-fetch dashboard data to update the UI
//     const res = await axios.get(`http://https://service-management-system-oc50.vercel.app/api/api/api/dashboard/${userId}`);
...
const ProviderDashboard = () => {
  ...
  const updateStatus = async (id, status) => {
    try {
      await axios.put(`http://https://service-management-system-oc50.vercel.app/api/api/api/bookings/${id}/provider-status`, { status, providerId: userId });
      fetchDashboard();
