...
//         `http://https://service-management-system-oc50.vercel.app/api/api/api/reviews/provider/${storedUser.id}`
//       );
...
//     await axios.put(
//       `http://https://service-management-system-oc50.vercel.app/api/api/api/reviews/${id}/reply`,
//       { reply }
//     );
//     fetchReviews();
//   };
...
//     await axios.put(
//       `http://https://service-management-system-oc50.vercel.app/api/api/api/reviews/${id}/report`
//     );
...
const ProviderReviews = () => {
  ...
  const fetchReviews = async () => {
    try {
      if (!userId) return;
      const res = await axios.get(
        `http://https://service-management-system-oc50.vercel.app/api/api/api/reviews/provider/${userId}`
      );
  ...
  const handleReport = async (id) => {
    try {
      await axios.put(`http://https://service-management-system-oc50.vercel.app/api/api/api/reviews/${id}/report`);
