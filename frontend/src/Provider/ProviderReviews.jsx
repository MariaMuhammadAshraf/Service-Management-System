...
//         `https://service-management-system-ywma.vercel.app/api/reviews/provider/${storedUser.id}`
//       );
...
//     await axios.put(
//       `https://service-management-system-ywma.vercel.app/api/reviews/${id}/reply`,
//       { reply }
//     );
//     fetchReviews();
//   };
...
//     await axios.put(
//       `https://service-management-system-ywma.vercel.app/api/reviews/${id}/report`
//     );
...
const ProviderReviews = () => {
  ...
  const fetchReviews = async () => {
    try {
      if (!userId) return;
      const res = await axios.get(
        `https://service-management-system-ywma.vercel.app/api/reviews/provider/${userId}`
      );
  ...
  const handleReport = async (id) => {
    try {
      await axios.put(`https://service-management-system-ywma.vercel.app/api/reviews/${id}/report`);
