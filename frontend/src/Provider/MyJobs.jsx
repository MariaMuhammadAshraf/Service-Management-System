...
//         `https://service-management-system-ywma.vercel.app/api/bookings/provider/${storedUser.id}`
//       );
//       setJobs(res.data);
//     } catch (error) {
//       console.error(error);
...
//   await axios.put(
//     `https://service-management-system-ywma.vercel.app/api/bookings/${id}/provider-status`,
//     {
//       status,
...
const MyJobs = () => {
  ...
  const fetchJobs = async () => {
    try {
      if (!userId) return;
      const res = await axios.get(
        `https://service-management-system-ywma.vercel.app/api/bookings/provider/${userId}`
      );
      setJobs(res.data);
    } catch (error) {
