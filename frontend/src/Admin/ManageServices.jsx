...
const ManageServices = () => {
  ...
  const fetchData = async () => {
    try {
      const [serviceRes, catRes] = await Promise.all([
        axios.get('http://https://service-management-system-oc50.vercel.app/api/api/api/services'),
        axios.get('http://https://service-management-system-oc50.vercel.app/api/api/api/categories')
      ]);
  ...
  const handleAddCategory = async () => {
    ...
    try {
      await axios.post('http://https://service-management-system-oc50.vercel.app/api/api/api/categories', { name: newCatName });
      setNewCatName("");
      fetchData();
  ...
  const deleteCategory = async (id) => {
    if (window.confirm("Delete this category?")) {
      await axios.delete(`http://https://service-management-system-oc50.vercel.app/api/api/api/categories/${id}`);
      fetchData();
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEditMode) {
        await axios.put(`http://https://service-management-system-oc50.vercel.app/api/api/api/services/${editingId}`, dataToSend);
      } else {
        await axios.post('http://https://service-management-system-oc50.vercel.app/api/api/api/services', dataToSend);
      }
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Delete this service?")) {
      await axios.delete(`http://https://service-management-system-oc50.vercel.app/api/api/api/services/${id}`);
      fetchData();
    }
  };
