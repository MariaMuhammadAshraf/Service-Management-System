...
//     try {
//       const res = await axios.get("http://https://service-management-system-oc50.vercel.app/api/api/api/reviews");
//       setReviews(res.data);
//     } catch (err) {
...
//     try {
//       await axios.put(`http://https://service-management-system-oc50.vercel.app/api/api/api/reviews/${id}/approve`);
//       fetchReviews();
//     } catch (err) {
//       console.error(err);
//     }
...
//     try {
//       await axios.put(`http://https://service-management-system-oc50.vercel.app/api/api/api/reviews/${id}/reject`);
//       fetchReviews();
//     } catch (err) {
//       console.error(err);
//     }
...
//     try {
//       await axios.delete(`http://https://service-management-system-oc50.vercel.app/api/api/api/reviews/${id}`);
//       fetchReviews();
//     } catch (err) {
//       console.error(err);
//     }
