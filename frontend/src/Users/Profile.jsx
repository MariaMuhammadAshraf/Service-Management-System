...
// //           `https://service-management-system-ywma.vercel.app/api/auth/user/${storedUser.id}`
// //         );
...
// //         `https://service-management-system-ywma.vercel.app/api/auth/update-profile/${storedUser.id}`,
// //         formData
// //       );
...
// //     const fetchUser = async () => {
// //       try {
// //         const res = await axios.get(`https://service-management-system-ywma.vercel.app/api/auth/user/${storedUser.id}`);
// //         setUserData(res.data);
...
// //     e.preventDefault();
// //     try {
// //       await axios.put(`https://service-management-system-ywma.vercel.app/api/auth/update-profile/${storedUser.id}`, formData);
// //       alert("Profile updated successfully ✅");
...
// //     setIsSaving(true);
// //     try {
// //       const res = await axios.put(`https://service-management-system-ywma.vercel.app/api/auth/update-profile/${storedUser.id}`, formData);
...
//       try {
//         if (!userId) return;
//         const res = await axios.get(`https://service-management-system-ywma.vercel.app/api/auth/user/${userId}`);
//         setUserData(res.data);
//         setFormData({ 
//           name: res.data.name || '', 
//           phone: res.data.phone || '', 
...
//     setIsSaving(true);
//     try {
//       const res = await axios.put(`https://service-management-system-ywma.vercel.app/api/auth/update-profile/${userId}`, formData);
//       localStorage.setItem("user", JSON.stringify({ ...storedUser, name: res.data.name }));
