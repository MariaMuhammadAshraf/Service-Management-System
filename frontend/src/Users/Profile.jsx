...
// //           `http://https://service-management-system-oc50.vercel.app/api/api/api/auth/user/${storedUser.id}`
// //         );
...
// //         `http://https://service-management-system-oc50.vercel.app/api/api/api/auth/update-profile/${storedUser.id}`,
// //         formData
// //       );
...
// //     const fetchUser = async () => {
// //       try {
// //         const res = await axios.get(`http://https://service-management-system-oc50.vercel.app/api/api/api/auth/user/${storedUser.id}`);
// //         setUserData(res.data);
...
// //     e.preventDefault();
// //     try {
// //       await axios.put(`http://https://service-management-system-oc50.vercel.app/api/api/api/auth/update-profile/${storedUser.id}`, formData);
// //       alert("Profile updated successfully ✅");
...
// //     setIsSaving(true);
// //     try {
// //       const res = await axios.put(`http://https://service-management-system-oc50.vercel.app/api/api/api/auth/update-profile/${storedUser.id}`, formData);
...
//       try {
//         if (!userId) return;
//         const res = await axios.get(`http://https://service-management-system-oc50.vercel.app/api/api/api/auth/user/${userId}`);
//         setUserData(res.data);
//         setFormData({ 
//           name: res.data.name || '', 
//           phone: res.data.phone || '', 
...
//     setIsSaving(true);
//     try {
//       const res = await axios.put(`http://https://service-management-system-oc50.vercel.app/api/api/api/auth/update-profile/${userId}`, formData);
//       localStorage.setItem("user", JSON.stringify({ ...storedUser, name: res.data.name }));
