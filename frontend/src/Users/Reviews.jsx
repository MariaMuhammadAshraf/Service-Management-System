...
//         `http://https://service-management-system-oc50.vercel.app/api/api/api/bookings/user/${storedUser.id}`
//       );
...
//         `http://https://service-management-system-oc50.vercel.app/api/api/api/reviews/user/${storedUser.id}`
//       );
...
//     try {
//       await axios.post("http://https://service-management-system-oc50.vercel.app/api/api/api/reviews", {
